...
import com.redhat.dao.UserDao;
import com.redhat.model.User;
import com.redhat.service.MailEngine;
import com.redhat.service.UserExistsException;
import com.redhat.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.redhat.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.redhat.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
