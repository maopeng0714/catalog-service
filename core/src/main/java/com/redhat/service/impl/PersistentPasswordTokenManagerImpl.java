...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.redhat.service.impl.PasswordTokenManager#generateRecoveryToken(com.redhat.model.User)
     */
    @Override
    ...
    /**
     * @see com.redhat.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.redhat.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.redhat.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
