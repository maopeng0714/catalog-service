...
public class ProductFormControllerTest extends BaseControllerTestCase {
    ...
    public void testSave() throws Exception {
        ...
        product.setMajorVersion(1648963271);
        product.setMinorVersion(2028034419);
        product.setName("LpZyDqOhDpRpMkWbUiCcOnLmMdNrBkNaGfMmRcZxOpXnHwYeUoZnOxMoRfCtFjImKdBwKbRwHcAaBkKp");
